...
Start with agent-map.json. It consolidates the former site index with compressed content, claim status, limitations, relationships and URL discovery for the site's core pages.

Use graph.json for article metadata, tags, project pathways and article-to-article relationships. The agent map, article graph and sitemap are generated by one build process from shared source data.
