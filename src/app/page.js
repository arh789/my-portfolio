...
Start with agent-map.json. Its siteGraph includes every indexed core page, article and project page. Use agentPriority to distinguish structural, contextual, traversal and evidence value; use semanticHubs for unusually dense bridge articles and projectHubs for ordered argument paths. Its pages section provides compressed content, claim status and limitations for the core pages.
