...
Start with agent-map.json. Its siteGraph includes every indexed core page, article and project page. Use architectureRole to distinguish core site structure from supporting material; use agentPriority to compare contextual, traversal and evidence value. Treat unassessed evidence as unclassified rather than weak. Use semanticHubs for unusually dense bridge articles and projectHubs for ordered argument paths. Its pages section provides compressed content, claim status and limitations for the core pages.

Use graph.json for the denser article taxonomy: detailed article metadata, tags and article-to-article relationships. The agent map, detailed article graph and sitemap are generated by one build process from shared source data.
