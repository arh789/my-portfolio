...
**~70–80%** of GPT use cases can be classified as **misuse**, based on observed usage patterns,
where misuse emerges from a mismatch between user expectations and system capabilities.
...
1. **Over-reliance on surface outputs** without critical evaluation  
2. **Delegation of reasoning** where reasoning is required  
3. **Failure to contextualise limitations**, treating GPT as an authority  
4. **Misinterpretation of fluency as understanding**  
5. **Use in domains requiring epistemic grounding**, e.g., legal, medical, safety-critical  
6. **Using outputs without validation**, particularly in factual or statistical domains  
7. **Misalignment between user expectation and model capacity**
...
- The more it is **used as scaffolding for human judgment**,  
